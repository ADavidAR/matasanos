window.addEventListener("DOMContentLoaded", async () => {
    ...
    const idProveedorDetails = details.proveedor.idProveedor;

    const responseProv = await fetch(`/api/proveedores/${idProveedorDetails}`);
    const proveedorInfo = await responseProv.json();
    console.log(proveedorInfo);
    ...
    column.innerHTML = `
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item" type="hidden">Proveedor: ${proveedorInfo.razonSocial}</li>
          </ul>
      `;
