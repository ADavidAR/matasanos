...
VALUES 
    ('Centro', 'Av. Principal #123', 1),  -- Direcci�n en Tegucigalpa
    ('Zona Industrial', 'Calle Secundaria #456', 2); -- Direcci�n en San Pedro Sula
...
VALUES
    ('Carlos', 'Alberto', 'Gomez', 'P�rez', '1234567890', 'carlos.gomez@empresa.com', 3000.00, '2025-03-01', 1, NULL, 1, 1, 1, 1, 1, NULL),  
...
VALUES
    ('Laboratorios F�rmaco S.A.', 'Mar�a L�pez', '0801199012345', '2234-5678', 'mlopez@farmaco.hn', 'Blvd. Centroam�rica, Tegucigalpa'),
    ('Distribuidora M�dica del Norte', 'Carlos Rivera', '0801198709876', '2245-9988', 'crivera@dmn.com', 'Col. Kennedy, Tegucigalpa'),
    ('SanaSana Importaciones', 'Ana G�mez', '0801198511123', '2230-1122', 'ana@sanasana.hn', 'Barrio Abajo, San Pedro Sula'),
...
VALUES
    ('Paracetamol 500mg', 'Analg�sico para dolores leves', 15.00, 100, '2026-12-31', 1, 12.00, GETDATE(), NULL, 1, 1, 1, NULL),
    ('Ibuprofeno 400mg', 'Analg�sico y antiinflamatorio', 20.00, 150, '2026-10-31', 1, NULL, GETDATE(), NULL, 1, 1, 1, NULL),
    ('Vitamina C 1000mg', 'Suplemento inmunol�gico', 30.00, 80, '2025-08-30', 1, 25.00, GETDATE(), NULL, 3, 1, 1, NULL);
